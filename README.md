...
* 提供shiro权限路由跳转配置服务，生成集中式swagger接口文档。
...
请求处理 | 支持ajax跨域请求不丢失cookie配置 | 已完成 | 2018年6月26日 |已发布 | 1.1.2-RELEASE
请求处理 | 访问接口时初始化一对非对称密钥凭证的路径配置 | 已完成 | 2018年6月26日 |已发布 | 1.1.2-RELEASE
请求处理 | 微服务提供者实现feign接口时不需要再手动重复加@RequestBody、@PathVariable、@RequestParam等注解 | 已完成 | 2018年6月29日 |已发布 | 1.1.2-RELEASE
mybatis使用 | 扩展example条件查询及自动组装实体条件和分页 | 已完成 | 	2017年8月10日 | 已发布 | 1.1.3-RELEASE
单点登录 | 登录工具类扩展调用方法 | 已完成 | 	2017年8月24日 | 已发布 | 1.1.3-RELEASE
生成接口文档 | swagger文档组名支持中文配置，添加扩展请求接口 | 已完成 | 2018年8月25日 | 已发布 | 1.1.3-RELEASE

## 任务计划
* 开发一个后台管理系统（jenny项目），结合实际需求优化和扩展框架
