...
public class RulesDelegate implements Rules {
	...
	public boolean generateSelectByConditions() {
		return rules.generateSelectByConditions();
	}

	public boolean generateSelectCountByConditions() {
		return rules.generateSelectCountByConditions();
	}
