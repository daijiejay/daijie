 ...
 * 
 */
public class DeleteLogicByPrimaryKeyElementGenerator extends AbstractXmlElementGenerator {

	public DeleteLogicByPrimaryKeyElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute("id", introspectedTable.getDeleteLogicByPrimaryKeyStatementId())); //$NON-NLS-1$
