 ...
 * 
 */
public class SelectCountByConditionsElementGenerator extends AbstractXmlElementGenerator {

	public SelectCountByConditionsElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute("id", introspectedTable.getSelectCountByConditionsStatementId())); //$NON-NLS-1$
