...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		 ...
		 */
		ATTR_MYBATIS3_JAVA_MAPPER_TYPE, ATTR_FULLY_QUALIFIED_TABLE_NAME_AT_RUNTIME, ATTR_ALIASED_FULLY_QUALIFIED_TABLE_NAME_AT_RUNTIME, ATTR_COUNT_BY_EXAMPLE_STATEMENT_ID, ATTR_DELETE_BY_EXAMPLE_STATEMENT_ID, ATTR_DELETE_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_INSERT_STATEMENT_ID, ATTR_INSERT_SELECTIVE_STATEMENT_ID, ATTR_SELECT_BY_EXAMPLE_STATEMENT_ID, ATTR_SELECT_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID, ATTR_SELECT_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_SELECT_BY_CONDITIONS_STATEMENT_ID, ATTR_DELETE_LOGIC_BY_CONDITIONS_STATEMENT_ID, ATTR_DELETE_LOGIC_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_SELECT_COUNT_BY_CONDITIONS_STATEMENT_ID, ATTR_UPDATE_BY_CONDITIONS_SELECTIVE_STATEMENT_ID, ATTR_UPDATE_BY_EXAMPLE_STATEMENT_ID, ATTR_UPDATE_BY_EXAMPLE_SELECTIVE_STATEMENT_ID, ATTR_UPDATE_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID, ATTR_UPDATE_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_UPDATE_BY_PRIMARY_KEY_SELECTIVE_STATEMENT_ID, ATTR_UPDATE_BY_PRIMARY_KEY_WITH_BLOBS_STATEMENT_ID, ATTR_BASE_RESULT_MAP_ID, ATTR_RESULT_MAP_WITH_BLOBS_ID, ATTR_EXAMPLE_WHERE_CLAUSE_ID, ATTR_BASE_COLUMN_LIST_ID, ATTR_BLOB_COLUMN_LIST_ID, ATTR_MYBATIS3_UPDATE_BY_EXAMPLE_WHERE_CLAUSE_ID, ATTR_MYBATIS3_SQL_PROVIDER_TYPE
	}
	...
	protected void calculateXmlAttributes() {
		...
		setSelectCountByConditionsStatementId("selectCountByConditions"); //$NON-NLS-1$
		setSelectByConditionsStatementId("selectByConditions"); //$NON-NLS-1$
		setDeleteLogicByConditionsStatementId("deleteLogicByConditions");
		setDeleteLogicByPrimaryKeyStatementId("deleteLogicByPrimaryKey");
		setUpdateByConditionsSelectiveStatementId("updateByConditionsSelective");
	}
	...
	public void setSelectByConditionsStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_SELECT_BY_CONDITIONS_STATEMENT_ID, s);
	}

	public void setDeleteLogicByConditionsStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_DELETE_LOGIC_BY_CONDITIONS_STATEMENT_ID, s);
	}

	public void setDeleteLogicByPrimaryKeyStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_DELETE_LOGIC_BY_PRIMARY_KEY_STATEMENT_ID, s);
	}

	public void setUpdateByConditionsSelectiveStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_UPDATE_BY_CONDITIONS_SELECTIVE_STATEMENT_ID, s);
	}

	public void setSelectCountByConditionsStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_SELECT_COUNT_BY_CONDITIONS_STATEMENT_ID, s);
	}
	...
	public String getSelectByConditionsStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_SELECT_BY_CONDITIONS_STATEMENT_ID);
	}

	public String getSelectCountByConditionsStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_SELECT_COUNT_BY_CONDITIONS_STATEMENT_ID);
	}

	public String getUpdateByConditionsSelectiveStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_UPDATE_BY_CONDITIONS_SELECTIVE_STATEMENT_ID);
	}

	public String getDeleteLogicByConditionsStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_DELETE_LOGIC_BY_CONDITIONS_STATEMENT_ID);
	}

	public String getDeleteLogicByPrimaryKeyStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_DELETE_LOGIC_BY_PRIMARY_KEY_STATEMENT_ID);
	}
