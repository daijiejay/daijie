	...
	public Object getDocumentation(
		...
		try {
			...
			if (!zuulSwaggerProperties.getRoutes().isEmpty()) {
				Iterator<Entry<String, ZuulSwaggerProperties.ZuulRoute>> iterator = zuulSwaggerProperties.getRoutes().entrySet().iterator();
				while (iterator.hasNext()) {
					Entry<String, ZuulSwaggerProperties.ZuulRoute> next = iterator.next();
